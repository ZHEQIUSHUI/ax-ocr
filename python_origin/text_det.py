...
class TextDetector():
    def __init__(self):
        ...
        self.session = onnxruntime.InferenceSession('models/onnx/ppocr_det_v3.onnx', so)
    ...
    def letterbox(self, image, target_size, color=(114, 114, 114)):
        ...
        padded_image = cv2.copyMakeBorder(
            resized_image, 
            pad_height, target_height - new_height - pad_height, 
            pad_width, target_width - new_width - pad_width,
            cv2.BORDER_CONSTANT, 
            value=color
        )
